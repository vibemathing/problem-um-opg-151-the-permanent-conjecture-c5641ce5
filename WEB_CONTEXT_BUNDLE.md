...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-151-the-permanent-conjecture-c5641ce5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-151"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-151-the-permanent-conjecture-c5641ce5-v1",
      "problem_contract_sha256": "d5d9369754753f2efbc6bc20dac269fd555902cd493e82b709783822d9b40f50",
      "problem_id": "problem:um-opg-151-the-permanent-conjecture-c5641ce5",
      "route_id": "route:um-opg-151-the-permanent-conjecture-c5641ce5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-151-the-permanent-conjecture-c5641ce5-source-fidelity-01",
      "graph_id": "graph:um-opg-151-the-permanent-conjecture-c5641ce5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-151-the-permanent-conjecture-c5641ce5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-151-the-permanent-conjecture-c5641ce5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture If $A$ is an invertible $n \\times n$ matrix, then there is an $n \\times n$ submatrix $B$ of $[A A]$ so that $perm(B)$ is nonzero."
          },
          "statement_sha256": "3866228e520f6634efa14ef33d4cec41aa5825fa927b1ce2283d3c097c1af0c3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-151-the-permanent-conjecture-c5641ce5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-151-the-permanent-conjecture-c5641ce5-root",
      "route_id": "route:um-opg-151-the-permanent-conjecture-c5641ce5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-151-7b5c8612cd91",
        "url": "https://www.unsolvedmath.com/problems/OPG-151"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
